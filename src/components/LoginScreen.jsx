...
function LoginScreen({ onLoginSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (isLogin) {
      ...
      if (result.success) {
        setSuccess(result.message + ' - Please login now')
  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 animate-slide-up">
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto">
        {!isLogin && (
          <div className="mb-4">
            <label htmlFor="name" className="block text-sm font-semibold text-kenya-black mb-2">
        ...
        <div className="mb-4">
          <label htmlFor="email" className="block text-sm font-semibold text-kenya-black mb-2">
        ...
        <div className="mb-6">
          <label htmlFor="password" className="block text-sm font-semibold text-kenya-black mb-2">
